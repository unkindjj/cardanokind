...
-- | Convenience function to make a 'TxBodyContent' for the simple case of
-- the 'ByronEra'.
--
...
-- | Convenience function to make a 'TxBodyContent' for the case of the
-- 'ShelleyEra' specifically. This takes all the required fields. The
-- 'TxBodyContent' has several optional fields that can be overriden.
--
-- Note that the 'TxValidityUpperBound' is required in the 'ShelleyEra'
-- specifically, and optional in all later eras.
--
makeShelleyTxBodyContent :: [TxIn]
                         ...
                         -> TxFee era
                         -> TxBodyContent era
makeShelleyTxBodyContent txIns txOuts upperBound fee =
    TxBodyContent {
      txIns,
      txOuts,
      txFee            = fee,
